...
export const GITHUB_POLICY_HINT_LINES = [
	"",
	"**GitHub policy:** deployment protection, fork **`staging-fork`** rules, merge buttons, and repository rulesets are set in **`config/github.policy.ts`** (TypeScript, versioned). Run **`bun run typecheck`** after editing.",
